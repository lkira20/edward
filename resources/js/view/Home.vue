	...
	export default{
		...
		methods:{
			...
			sincronizar(){
				...
				axios.put('http://127.0.0.1:8000/api/actualizar-dinero-piso-venta/'+this.id, {dinero: this.piso_venta_selected.dinero}).then(response => {//EN LA WEB
				...
				axios.get('http://127.0.0.1:8000/api/ultima-vaciada-caja/'+this.id).then(response => {//WEB
					console.log(response)
					...
					axios.get('/api/ultima-vaciada-caja-local/'+ultima_caja.id_extra).then(response => {
						...
						if (cajas.length > 0) {
							...
							axios.post('http://127.0.0.1:8000/api/registrar-cajas', {cajas: cajas}).then(response => {//WEB
				...
				axios.post('/api/sincronizacion', {id: this.id}).then(response => {
					...
					axios.post('http://127.0.0.1:8000/api/sincronizacion', {id: this.id}).then(response => {//WEB
						console.log(response);
						//SINC
